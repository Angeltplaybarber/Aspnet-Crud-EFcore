...
namespace Aspnet_Crud_EFcore.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(JourneyHubContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EmployeesId,FirstName,LastName,Email,Phone")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeesId,FirstName,LastName,Email,Phone")] Employee employee)
        {
